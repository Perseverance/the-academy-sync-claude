...
# Create temporary .env.production.local file for Next.js build
# This ensures Next.js picks up the correct API URL during static build
# Note: .env.production.local has highest priority in Next.js env loading order
print_info "Creating temporary .env.production.local with API URL..."
